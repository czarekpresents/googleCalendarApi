package com.cezetpro.calendar.services.impl;
...
public class CalendarServiceImpl implements CalendarService {
    ...
    private Credential getCredentials(final NetHttpTransport httpTransport) throws IOException {
        // Load client secrets
        InputStream in =
                Optional.ofNullable(CalendarServiceImpl.class.getResourceAsStream(CREDENTIALS_FILE_PATH))
                        .orElseThrow(
                                () -> new FileNotFoundException("Resource not found: " + CREDENTIALS_FILE_PATH));
